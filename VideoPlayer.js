...
export default class VideoPlayer extends Component {
  ...
  /**
   * Toggle between showing muted or unmuted
   */
  _toggleMute() {
    let state = this.state;
  ...
  /**
   * Muted button control
   */
  renderMuted() {
    let source = this.state.muted === true ? require( './assets/img/pause.png' ) : require( './assets/img/volume.png' );
   ...
   */
  renderVolume() {
    const source = this.state.muted === true ? require( './assets/img/pause.png' ) : require( './assets/img/volume.png' );
  ...
  >
  <Image style={ styles.volume.icon } source={ source } />
    </TouchableHighlight>
    </View>
    </View>
  );
